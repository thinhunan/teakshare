...
# 允许 None（环境/权限）的接口
# mootdx / Tushare 高权限 / 全市场类接口：无凭证时允许 skip
OPTIONAL_IDS: Set[str] = {
    "tick_data",
    "tick_data_history",  # mootdx 逐笔 — 暂不强制
    "depth",  # 常走 tdx，无 mootdx 时为 None
    "stk_mins",  # Tushare 分钟权限
    "finance_snapshot",
    "f10",
    "xdxr",
    "valuation_history",
    ...
    "express",
    "fund_flow_baidu",
    "iwencai",  # 无 Node / pywencai / IWENCAI_API_KEY.txt 时 skip
}
